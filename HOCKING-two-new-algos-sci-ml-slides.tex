...
\begin{frame}
  ...
  \begin{itemize}
  \item Create three data sets by combining MNIST with variants:
    EMNIST, EMNIST\_rot, FashionMNIST.
  \item Each of these three new data sets has two subsets: MNIST/variant.
  \end{itemize}
...
\begin{frame}
  ...
  \item Proposed AUM loss uses a
    different/novel L1 relaxation.
  \item Proposed AUM loss can be used as a drop-in replacement for logistic/binary cross-entropy loss. PyTorch code: \url{https://tdhock.github.io/blog/2024/torch-roc-aum/}
