...
\begin{frame} \frametitle{Evaluating imbalanced binary classification}
  ...
  \item ROC curves are useful because featureless baseline always has
    Area Under Curve (AUC) of 0.5.
  \item AUC$>0.5$ means the algorithm has learned something non-trivial.
  \end{itemize}
